...
function AnaglyphEffect(renderer, width, height) {
    ...
    let _params = {minFilter: THREE.LinearFilter, magFilter: THREE.NearestFilter, format: THREE.RGBAFormat};
    ...
    let _mesh = new THREE.Mesh(new THREE.PlaneBufferGeometry(2, 2), _material);
    _scene.add(_mesh);
    ...
    this.setEyeSep = function (newEyeSep) {
